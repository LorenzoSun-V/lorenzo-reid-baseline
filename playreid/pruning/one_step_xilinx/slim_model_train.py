...
def setup(args):
    ...
    cfg.freeze()
    default_setup(cfg, args, 'log_slim_model_train.txt')
    return cfg


def retrain_slim_model(cfg, args, model, train_loader):
    ...
    with EventStorage(start_iter) as storage:
        for epoch in range(start_epoch, max_epoch):
            ...
            if metric_dict["metric"] > best_metric:
                ...
                Checkpointer(model, cfg.OUTPUT_DIR).save(f"model_slim_{args.sparsity}")
...
def main(args):
    ...
    retrain_slim_model(cfg, args, model, train_loader)
