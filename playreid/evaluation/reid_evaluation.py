...
from playreid.utils.compute_dist import build_dist
...
class ReidEvaluator(DatasetEvaluator):
    ...
    def evaluate(self):
        ...
        # print(dist.shape, type(dist)): (m * n)
        # print(query_pids.shape, type(query_pids)): (m, )
        # print(gallery_pids.shape, type(gallery_pids)): (n, )
        # print(query_camids.shape, type(query_camids)): (m, )
        # print(gallery_camids.shape, type(gallery_camids)): (n:)
        evaluate_time = time.time()
        cmc, all_AP, all_INP = evaluate_rank(dist, query_pids, gallery_pids, query_camids, gallery_camids)
        logger.info("Total calculation time of cmc: {:.6f}".format(time.time() - evaluate_time))
