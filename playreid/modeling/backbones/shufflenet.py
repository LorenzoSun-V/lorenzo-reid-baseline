...
import logging
from playreid.utils.checkpoint import get_missing_parameters_message, get_unexpected_parameters_message

from playreid.layers import get_norm
from playreid.modeling.backbones import BACKBONE_REGISTRY
