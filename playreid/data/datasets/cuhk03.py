...
class CUHK03(ImageDataset):
    ...
    def __init__(self, root='datasets', split_id=0, cuhk03_labeled=True, cuhk03_classic_split=False, **kwargs):
        ...
        # cmdm dataset:
        assert os.path.exists(self.dataset_dir), "Please check dataset CUHK03 path!"
    ...
    def process_dir(self, dir_path, is_train=True):
        ...
        for pid_folder in pid_folders:
            img_paths = glob.glob(osp.join(dir_path, pid_folder, '*.png'))
