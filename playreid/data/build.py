...
def build_common_train_loader(
    ...
    train_loader = DataLoader(dataset=train_set, num_workers=num_workers, batch_sampler=batch_sampler,
...
@configurable(from_config=_test_loader_from_config)
def build_reid_sub_test_loader(test_set, test_batch_size, num_query, num_workers=4):
    val_subnet = torch.utils.data.Subset(test_set, list(range(2)))
